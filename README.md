...
Here are some sample content-based recommendations generated by the TF-IDF model:

### Inception (2010)
- **Donnie Darko (2001)** (sim: 0.344)
- **Arrival (2016)** (sim: 0.309)
- **Strange Days (1995)** (sim: 0.309)

### The Imitation Game (2014)
- **Basic (2003)** (sim: 0.624)
- **Fail-Safe (1964)** (sim: 0.624)
- **Brothers (2009)** (sim: 0.624)

### The Matrix (1999)
- **La Jetée (1962)** (sim: 0.502)
- **The Postman (1997)** (sim: 0.430)
- **Johnny Mnemonic (1995)** (sim: 0.426)

**Qualitative Assessment**: Content-based recommendations succeed when metadata is rich - animated family movies like *Toy Story* share dense tags and genres. However, TF-IDF is limited to keyword vocabulary rather than tone or scale, which leads to matching *The Matrix* with the experimental French short *La Jetée*. Furthermore, when tag data is sparse (as with *The Imitation Game*), the model falls back to raw genre list matching, causing flat similarity score ties.
